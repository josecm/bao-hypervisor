...
#define MEM_FLAGS_INVALID              PTE_FLAGS(0, 0, 0)
#define MEM_HYP_FLAGS            PTE_FLAGS(1, 1, 1)
#define MEM_HYP_DEV_FLAGS        PTE_FLAGS(1, 1, 0)
#define MEM_VM_FLAGS             PTE_FLAGS(1, 1, 1)
#define MEM_VM_RX_FLAGS          PTE_FLAGS(0, 1, 1)
#define MEM_VM_RW_FLAGS          PTE_FLAGS(1, 1, 0)
#define MEM_VM_R_FLAGS           PTE_FLAGS(0, 1, 0)
#define MEM_VM_DEV_FLAGS         PTE_FLAGS(1, 1, 0)
#define MEM_HYP_FLAGS_CODE       PTE_FLAGS(0, 1, 1)
