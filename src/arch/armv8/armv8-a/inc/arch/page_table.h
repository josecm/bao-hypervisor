...
#define MEM_HYP_FLAGS             (PTE_ATTR(1) | PTE_AP_RW | PTE_SH_IS | PTE_AF)
#define MEM_HYP_DEV_FLAGS         (PTE_ATTR(2) | PTE_AP_RW | PTE_SH_IS | PTE_AF | PTE_XN)

#define PTE_VM_MEM_BASE  (PTE_MEMATTR_NRML_OWBC | PTE_MEMATTR_NRML_IWBC | PTE_SH_NS | PTE_AF)

#define MEM_VM_FLAGS     (PTE_VM_MEM_BASE | PTE_S2AP_RW)
#define MEM_VM_RX_FLAGS  (PTE_VM_MEM_BASE | PTE_S2AP_RO)
#define MEM_VM_RW_FLAGS  (PTE_VM_MEM_BASE | PTE_S2AP_RW | PTE_XN)
#define MEM_VM_R_FLAGS   (PTE_VM_MEM_BASE | PTE_S2AP_RO | PTE_XN)

#define MEM_VM_DEV_FLAGS (PTE_MEMATTR_DEV_GRE | PTE_SH_NS | PTE_S2AP_RW | PTE_AF)
