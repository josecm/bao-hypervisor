...
#define PTE_VM_RX_FLAGS  PTE_FLAGS(PRBAR_AP_RO_EL1_EL2 | PRBAR_SH_NS, PRLAR_ATTR(1) | PRLAR_EN)
#define PTE_VM_RW_FLAGS  PTE_FLAGS(PRBAR_XN | PRBAR_AP_RW_EL1_EL2 | PRBAR_SH_NS, PRLAR_ATTR(1) | PRLAR_EN)
#define PTE_VM_R_FLAGS   PTE_FLAGS(PRBAR_XN | PRBAR_AP_RO_EL1_EL2 | PRBAR_SH_NS, PRLAR_ATTR(1) | PRLAR_EN)
