...
static void LINFLEXD_SetUartWordLength(volatile struct LINFlexD_Type *base, linflexd_uart_word_length_t length)
{
    uint32_t regValTemp;
...
static void LINFLEXD_SetInterruptMode(volatile struct LINFlexD_Type * base, uint32_t intSrc, bool enable)
{
    uint32_t regValTemp;
